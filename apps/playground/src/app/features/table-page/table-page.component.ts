...
import { CacTableComponent, GetOfflineAdapter } from '@controladad/ng-base';
import { delay, of } from 'rxjs';
import { CacTableExtenderDirective, table } from './table-extended/cac-table-extender.directive';

@Component({
  selector: 'app-table-page',
  imports: [CacTableComponent, CacTableExtenderDirective],
