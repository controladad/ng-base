...
export const DateHelper = {
  intervalToFormattedTime(start: Date, end: Date, showSymbol?: boolean) {
  ...
  format(date: string | Date | undefined, format = 'yyyy/MM/dd') {
